 ...
 * 大部分代码来自DefaultItemAnimator，原本想直接继承DefaultItemAnimator
 * 但是发现要修改的地方是属于private方法，因此复制过来成新的动画类，
 * 只修改了animateRemoveImpl方法，也就是修改了移除item的动画效果
 */

public class FadeItemAnimator extends SimpleItemAnimator {
	...
	private void animateRemoveImpl(final ViewHolder holder) {
		...
		myRemoveAnimation.setDuration(getRemoveDuration());//使用itemAnimator的Remove时间
